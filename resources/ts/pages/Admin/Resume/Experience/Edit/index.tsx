...
function EditExperience({ auth, experience }: InertiaProps) {
  ...
  const submit = (e: FormEvent<HTMLFormElement>) => {
    ...
    patch(route('experience.update', experience.id));
  };
  ...
  return (
    <AdminLayout user={auth.user}>
      ...
      <Breadcrumb pageName="Edit Experience" urlBefore={urlBefore} />
