...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/admin">
          <div className="flex flex-row items-center gap-3 text-4xl font-semibold text-white">
            <img src="/Logo FR.svg" alt="Logo" />
            <span>Project</span>
          </div>
        </Link>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li onClick={() => setSidebarOpen(false)}>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    url === '/admin' && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li onClick={() => setSidebarOpen(false)}>
                <Link
                  href="/admin/message"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    url.includes('message') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li onClick={() => setSidebarOpen(false)}>
                <Link
                  href="/admin/blog"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    url.includes('blog') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <span className="font-light italic">Aa</span>
                  Blog
                </Link>
              </li>
              {/* <!-- Menu Item Blog --> */}
              ...
              <li onClick={() => setSidebarOpen(false)}>
                <Link
                  href="/admin/hero"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    url.includes('hero') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li onClick={() => setSidebarOpen(false)}>
                <Link
                  href="/admin/project"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    url.includes('project') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li onClick={() => setSidebarOpen(false)}>
                <Link
                  href="/admin/skill"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    url.includes('skill') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <SidebarLinkGroup
                activeCondition={
                  url.includes('resume/education') ||
                  url.includes('resume/experience')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          url.includes('resume') && 'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
              ...
              <SidebarLinkGroup
                activeCondition={
                  url.includes('setting/contact') ||
                  url.includes('setting/social_media')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li onClick={() => setSidebarOpen(false)}>
                            <Link
                              href="/admin/setting/social_media"
                              className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                url.includes('social_media') &&
                                'bg-graydark dark:bg-meta-4'
                              }`}
                            >
                              Social Media
